...
const FAB_SCRIPT = `(function () {
  ...
  function init() {
    ...
    style.textContent = \`
      ...
      #__ocr-modal-actions button { padding: 7px 16px; border-radius: 6px; border: none; font-size: 13px; cursor: pointer; }
      #__ocr-modal-save { background: #4f46e5; color: #fff; }
      #__ocr-modal-save:hover { background: #6366f1; }
      #__ocr-modal-save:disabled { opacity: 0.5; cursor: default; }
      #__ocr-modal-cancel { background: #2d2d4e; color: #e2e8f0; }
